...
export const metadata: Metadata = {
  ...
  description: '1010markのポートフォリオのAboutページです。いろいろ知ることができます。',
}
...
export default async function Home() {
  return (
    <main>
      <img src={`${process.env.BASE_PATH}/image/icon.png`} alt="3と書いてあるアイコン" className="drop-shadow-md max-w-1/4 max-h-1/4 mx-auto my-2" />
      <div>
        <h1 className="text-center md:text-4xl text-3xl py-2 mx-auto md:w-2/4 w-3/4 border-b-2 text-gray-800 drop-shadow-sm">1010mark（寿限無）</h1>
        <p className="text-center my-2 mb-4 leading-relaxed">名前が覚えにくいです。寿限無とお呼びください。神戸の郊外出身。<br />
        ...
        <table className='mx-auto leading-loose'>
          ...
          <tbody>
            <tr>
              <td className='text-lg px-2 py-1.5'>Shaderlab</td>
              <td className={`${starclassname} after:w-[7.5rem]`}></td>
            </tr>
          </tbody>
          <tbody>
          ...
          <tbody>
            <tr>
              <td className='text-lg px-2 py-1.5'>React</td>
      ...
      <p className='text-gray-400 text-sm text-center mx-auto'>星5: 十分に理解しており、中級者以上に講習を行える自信がある。<br />
      星4: 十分に理解しており、初心者に講習を行える自信がある。<br />
      星3: ある程度理解しており、進んだ操作ができる。<br />
      星2: ある程度理解しており、基本的な操作ができる。<br />
      星1: ブランクがあるなどの理由で、ある程度の学習期間を必要とする。</p>
    </main>
  );
}
