  ...
  return (
    <main>
      ...
      <div className="mb-2 bg-cover sm:[background-image:url(/image/works/shadowplay/shadowplay.png)] [background-image:url(/image/works/shadowplay/shadowplay_trim.png)] p-0 h-screen relative
        before:absolute before:content-[''] before:overflow-x-hidden before:left-[-20vw] before:p-0 before:mx-0 before:top-0 before:bottom-0 before:z-[-1] before:w-[120vw] before:bg-black
        ...
        <h1 className="[filter:drop-shadow(2px_2px_0_black)] [writing-mode:vertical-rl] text-white absolute text-5xl font-medium sm:top-[30%] top-[35%] left-[20%] xl:right-[30%] md:left-[20%]">妄想駆動。</h1>
      </div> 
      ...
      <div className="border-gray-400 text-center rounded-3xl border-gray-500 border p-4">
        <div>
          <h1 className="m-4 text-3xl font-semibold">ワクワクあふれる作品制作。</h1>
